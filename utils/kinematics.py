...
def adSE3_Rp(R: np.ndarray, p: Union[list, np.ndarray]) -> np.ndarray:  # Take the velocity of floating base with respect to the world frame into respect to the base frame
